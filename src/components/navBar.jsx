    ...
    return (
        ...
        <div>
            ...
            <div className="sm:flex items-center md:pr-2 lg:pr-7 gap-x-1  text-white hidden mr-2 custom3 slide-down">
                <button className="px-3 lg:px-5 py-2 focus:outline-1 focus:outline-offset-1 rounded-3xl transition delay-100 duration-100 ease-in-out hover:translate-y-1 hover:shadow-2xl bg-black">Login</button>
                <button className="px-3 lg:px-5 bg-black hover:border hover:border-white focus:outline-white focus:outline-1 py-2 focus:outline-offset-1 rounded-3xl transition delay-100 duration-100 ease-in-out hover:translate-y-1 hover:shadow-2xl mr-2">Register</button>
            </div>
            </nav>

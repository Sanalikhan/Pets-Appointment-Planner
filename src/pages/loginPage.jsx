...
export default function LoginPage(){
    ...
    return  (
        <div className="min-h-screen  w-full flex justify-center bg-linear-to-br from-gray-200 to-yellow-100 items-center rounded-4xl relative">
          <div className="w-full md:w-1/2 mx-7 items-center flex flex-col gap-y-2 h-full bg-white py-32 shadow-2xl rounded-4xl justify-between">
            <div>
